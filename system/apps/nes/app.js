(function() {
	...
	function setScaleMode(scaleMode = "") {
		...
		if((scaleMode == "") || (scaleMode == null)) {
			canvas.className = "container";
			currentScaleMode = "";
			return;
		} else {
			if(currentScaleMode != "")
				canvas.classList.remove(currentScaleMode);
			
			canvas.classList.add(scaleMode);
		}
