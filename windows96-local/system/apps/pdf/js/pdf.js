...
function addLinkAttributes(link, {
  ...
  if (enabled) {
    const aLnk = link.title = urlNullRemoved;
    
    link.addEventListener('click', ()=>{
      parent.w96.ui.DialogCreator.create({
        body: `Open this link?<br><br>URL: ${aLnk}<br><br><a href="${aLnk}" target="_blank">Open externally</a>`,
        title: "Open URL",
        icon: "warning",
        buttons: [
          {
